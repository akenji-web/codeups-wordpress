    ...
    <div class="site-map__inner inner back-icon">
      <div class="site-map__container nav nav--wide">
        <ul class="nav__items">
          ...
          <li class="nav__item">
            <a href="#" class="nav__link nav__link--bk">ライセンス取得</a>
          </li>
          <li class="nav__item">
            <a href="#" class="nav__link nav__link--bk">貸切体験ダイビング</a>
          </li>
          <li class="nav__item">
            <a href="#" class="nav__link nav__link--bk">ナイトダイビング</a>
          </li>
          <li class="nav__item nav__item--bold">
        ...
        <ul class="nav__items">
          ...
          <li class="nav__item">
            <a href="#" class="nav__link nav__link--bk">ライセンス講習</a>
          </li>
          <li class="nav__item">
            <a href="#" class="nav__link nav__link--bk">体験ダイビング</a>
          </li>
          <li class="nav__item">
            <a href="#" class="nav__link nav__link--bk">ファンダイビング</a>
          </li>
        </ul>
        <ul class="nav__items">
          <li class="nav__item">
